...
class QuotationJob extends StatefulWidget {
  @override
  State<QuotationJob> createState() => _QuotationJobState();
}

class _QuotationJobState extends State<QuotationJob> {
// ทำต่อหน้านี้
  ...
  void _get_job_data_Quotation() async {
    ...
    setState(() => job_datas_quotation = newjob_data);
         job_datas_quotation.sort((a, b) => b.date.compareTo(a.date));  
      ...
      : Scrollbar(
       ...
       context.read<CustomerDeviceData>().status =
                    ...
                    title: Column(
                      ...
                      children: [
                        Text('${job_datas_quotation[index].hospital}',
                         style: TextStyle(
                                fontWeight: FontWeight.bold,
                              )),
                        Text(
                            '${job_datas_quotation[index].device_name} : ${job_datas_quotation[index].sn}'),
                        Text(
                            'date : ${job_datas_quotation[index].date.substring(0, 10)}'),
                        Text(
                            'error code ${job_datas_quotation[index].error_code}'),
                      ],
                    ),
                    trailing: IconButton(
                      onPressed: () {
                        ...
                        context.read<CustomerDeviceData>().servicereport_id =
                            '${job_datas_quotation[index].servicereport_id}';
